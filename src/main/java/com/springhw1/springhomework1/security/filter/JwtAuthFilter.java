package com.springhw1.springhomework1.security.filter;
...
public class JwtAuthFilter extends AbstractAuthenticationProcessingFilter {
    ...
    public Authentication attemptAuthentication(
        ...
        if (tokenPayload == null) {
            ...
            response.getWriter().write(objectMapper.writeValueAsString(ResponseDto.fail(String.valueOf(HttpStatus.BAD_REQUEST),"로그인이 필요합니다")));
            return null;
        }
